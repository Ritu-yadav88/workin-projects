...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	  ...
	  <section class="hero-wrap hero-wrap-2" style="background-image: url('images/asian-family-portrait-three-generation-32002850.jpg');" data-stellar-background-ratio="0.5">
    ...
    <ul style="display:flex;list-style:none;text-align:right;">
      ...
      <li style="padding:20px;color:white;font-size:20px;" ><a href="home.php#practice-section">President Message</a></li>
      <li style="padding:20px;color:white;font-size:20px;" ><a href="directory.php">Family Details</a></li>
      <li style="padding:20px;color:white;font-size:20px;" ><a href="home.php#member-section">Working Members</a></li>
      <li style="padding:20px;color:white;font-size:20px;" ><a href="home.php#gallery-section">Gallery</a></li>
      <li style="padding:20px;color:white;font-size:20px;" ><a href="home.php#contact-section">Contact Us</a></li>
    </ul>
     </footer>
